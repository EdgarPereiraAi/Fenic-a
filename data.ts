...
export const CHEF_LOGO = 'https://images.unsplash.com/photo-1583394293214-28dea15ee548?auto=format&fit=crop&w=400&q=80'; // Placeholder para o Chef

// Imagens específicas por categoria para um aspeto "World-Class"
...
export const MENU_DATA: Category[] = [
  {
    ...
    title: 'Entradas',
    items: [
      { id: 'e00', number: '00', name: 'Pão', price: '1.20€', ingredients: { pt: 'Pão fresco', en: 'Bread', fr: 'Pain', de: 'Brot', es: 'Pan fresco' }, image: IMG_BREAD },
      { id: 'e01', number: '01', name: 'Pão com Alho', price: '3.50€', ingredients: { pt: 'Pão com alho', en: 'Bread with garlic', fr: 'Pain à l\'ail', de: 'Brot mit knoblauch', es: 'Pan con ajo' }, image: IMG_BREAD },
      { id: 'e02', number: '02', name: 'Pão com Alho e Queijo', price: '4.50€', ingredients: { pt: 'Pão com alho e queijo', en: 'Bread with garlic and cheese', fr: 'Pain à l\'ail et fromage', de: 'Brot mit knoblauch und käse', es: 'Pan con ajo y queso' }, image: IMG_BREAD },
      { id: 'e03', number: '03', name: 'Pão com Alho, Queijo e Fiambre', price: '5.00€', ingredients: { pt: 'Pão com alho, queijo e fiambre', en: 'Bread with garlic, cheese and ham', fr: 'Pain à l\'ail, fromage et jambom', de: 'Brot mit knoblauch, käse und schinken', es: 'Pan con ajo, queso y jamón' }, image: IMG_BREAD },
      { id: 'e04', number: '04', name: 'Pão com alecrim', price: '3.00€', ingredients: { pt: 'Pão com alecrim', en: 'Rosemary bread', fr: 'Pain au romarin', de: 'Rosmarin-brot', es: 'Pan con romero' }, image: IMG_BREAD }
    ]
  },
  {
    id: 'massas',
    ...
    items: [
      { id: 'm44', number: '44', name: 'Lasagne da Casa', price: '11.00€', ingredients: { pt: 'Lasanha da casa', en: 'House lasagne', fr: 'Lasagnes maison', de: 'Haus lasagne', es: 'Lasaña de la casa' }, image: IMG_LASAGNA },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p06', number: '6', name: 'Amor', price: '10.00€', ingredients: { pt: 'Tomate, queijo, fiambre, delicias e camarão', en: 'Tomato, cheese, ham, crab and prawns', fr: 'Tomate, fromage, jambon, surimi et crevettes', de: 'Tomaten, käse, schinken, krabben und garnelen', es: 'Tomate, queso, jamón, surimi y gambas' }, image: IMG_PIZZA_CLASSIC },
      { id: 'p07', number: '7', name: 'Sicilia', price: '10.00€', ingredients: { pt: 'Tomate, queijo, cogumelos e salami', en: 'Tomato, cheese, mushrooms and salami', fr: 'Tomate, fromage, champignons et salami', de: 'Tomaten, käse, pilze e salami', es: 'Tomate, queso, champiñones y salami' }, image: IMG_PIZZA_CLASSIC },
      { id: 'p08', number: '8', name: 'Roma', price: '10.00€', ingredients: { pt: 'Tomate, queijo, atum e camarão', en: 'Tomato, cheese, tuna and prawns', fr: 'Tomate, fromage, thon et crevettes', de: 'Tomaten, käse, thunfisch und garnelen', es: 'Tomate, queso, atún y gambas' }, image: IMG_PIZZA_CLASSIC },
      ...
      { id: 'p19', number: '19', name: 'Vegetariana', price: '10.00€', ingredients: { pt: 'Tomate, queijo, cebola, cogumelos, ananás, banana e pimento', en: 'Tomato, cheese, onions, mushrooms, pine-apple, banana and peppers', fr: 'Tomate, fromage, oignon, champignons, ananas, banane et piment vert', de: 'Tomaten, käse, zwiebeln, pilze, pinienapfel, bananen und paprika', es: 'Tomate, queso, cebolla, champiñones, piña, plátano y pimiento' }, image: IMG_PIZZA_CLASSIC },
      ...
      { id: 'p23', number: '23', name: 'Algarvia', price: '10.00€', ingredients: { pt: 'Tomate, queijo, fiambre, cebola e bacon', en: 'Tomato, cheese, ham, onions and bacon', fr: 'Tomate, fromage, jambon, oignons et bacon', de: 'Tomaten, käse, schinken, zwiebeln und speck', es: 'Tomate, queso, jamón, cebolla y bacon' }, image: IMG_PIZZA_CLASSIC }
    ]
  },
  {
    id: 'pizzas-especiais',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 's36', number: '36', name: 'Salada Mista', price: '6.00€', ingredients: { pt: 'Alface, tomate, pepino, cebola e pimento', en: 'Lettuce, tomato, cucumber, onions and peppers', fr: 'Laitue, tomate, concombre, oignon et piment', de: 'Salat, tomaten, gurken, zwiebeln und paprika', es: 'Lechuga, tomate, pepino, cebolla y pimiento' }, image: IMG_SALAD }
    ]
  },
  {
    id: 'especialidades',
