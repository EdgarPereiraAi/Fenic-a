...
// Imagens genéricas de alta qualidade para o menu base
...
const IMG_MILANO_PIZZA = 'https://images.unsplash.com/photo-1593504049359-74330189a345?auto=format&fit=crop&w=800&q=80'; // Imagem atualizada da Milano
...
export const MENU_DATA: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p02', number: '2', name: 'Milano', price: '9.50€', ingredients: { pt: 'Tomate, queijo, fiambre', en: 'Tomato, cheese and ham', fr: 'Tomate, fromage et jambon', de: 'Tomaten, käse und schinken', es: 'Tomate, queso y jamón' }, image: IMG_MILANO_PIZZA },
